from tkinter import Button, OptionMenu, Checkbutton, Frame, Scrollbar, Text, VERTICAL
...
class RunAlgorithmButton(Button):
     def __init__(self, master, command, text=RUN):
        super().__init__(master=master,
                         text=text,
                         font=FONT_RUN,
                         command=command
...
class AlgorithmCheckbutton(Checkbutton):
